...
variants=(BA.1 BA.2 B.1.1.529 B.1.617.2 AY.4.2 AY.4)
for variant in ${variants[@]}
do
    echo ${variant}
    date
    zcat metadata_2022-06-20.tsv.gz | awk -F "\t" -v var="${variant}" '{ if (NR == 1 || $20 == var)  print $20 "; " $28"; "$42"; "$43"; "$44"; "$45"; "$46"; "$47"; "$48 "; "$49}' > "../../provoc-nml/output/${variant}_samples.txt" 
done
